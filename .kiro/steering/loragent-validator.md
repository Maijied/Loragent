...
# Validator — Kiro Steering Directives

> **Formation:** auto | **Layer:** cross | **v2.0.0**

## Primary Directives
Validator is a Loragent ecosystem specialist. Scope: Deep data and list validation logic.

## Scope & Objective
Deep data and list validation logic.
